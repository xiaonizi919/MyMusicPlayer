...
public interface NetConfig {
    ...
    String LIANG_LIANG = "http://172.16.47.206:8080/Music/liangliang.mp3";//凉凉  张碧晨&杨宗纬
    String PIAO_YANG_GUOHAI = "http://172.16.47.206:8080/Music/pyghlkn.mp3";//漂洋过海来看你  朱亚文&王丽坤
    String GANG_HAO_YU_JIAN_NI = "http://172.16.47.206:8080/Music/ghyjn.mp3";//刚好遇见你  李玉刚
    String XIN_YANG = "http://172.16.47.206:8080/Music/xinyang.mp3"; //信仰  张信哲
}
